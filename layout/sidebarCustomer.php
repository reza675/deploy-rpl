...
<head>
    ...
    <style>
    <?php if($currentPage === 'dashboardCustomer.php' || $currentPage === 'search.php'): ?>
    [drawer-backdrop] {
...
<body>
    ...
    <div id="drawer-navigation"
        class="fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-[#E1CDB1]"
        tabindex="-1" aria-labelledby="drawer-navigation-label">
        <img src="../../assets/gambar/logo.png" alt="logoSimaBer" class="mix-blend-multiply mx-0 w-24 h-24">
        <button type="button" data-drawer-hide="drawer-navigation" aria-controls="drawer-navigation"
            class="text-black bg-transparent rounded-lg text-sm p-1.5 absolute top-2.5 end-2.5 inline-flex items-center dark:hover:bg-[#c0a080] dark:hover:text-white">
