...
if ($search !== '') {
    ...
    $where = "WHERE namaPelanggan LIKE '%{$escSearch}%'";
}

//Hitung total data & total halaman
$totalQ = mysqli_query($conn, "SELECT COUNT(*) AS total FROM pelanggan {$where}");
$totalData = mysqli_fetch_assoc($totalQ)['total'];
$totalPages = ceil($totalData / $itemsPerPage);

//Ambil data pelanggan dengan filter & paginasi
$sql   = "SELECT * FROM pelanggan {$where} LIMIT {$itemsPerPage} OFFSET {$offset}";
    ...
    <div class="main-container ml-[300px] mt-4 mr-12">
        <div class="flex justify-between items-center gap-6">
            <div class="flex-shrink-0">
                <p class="text-2xl text-[#16151C] font-bold">Management Customer</p>
                <p class="text-l text-[#5D5C61] font-regular">Customer Detail Information</p>
            </div>
        ...
        <div class="rounded-2xl border border-[#A2A1A8] shadow-lg p-8 mt-4 mb-4">
            <div class="relative flex justify-between items-center gap-4">
                <div class="relative flex-grow">
                    <form action="customer.php" method="get" class="relative">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="absolute w-5 h-5 top-2.5 left-2.5 text-slate-600">
                            <path fill-rule="evenodd"
                                d="M10.5 3.75a6.75 6.75 0 1 0 0 13.5 6.75 6.75 0 0 0 0-13.5ZM2.25 10.5a8.25 8.25 0 1 1 14.59 5.28l4.69 4.69a.75.75 0 1 1-1.06 1.06l-4.69-4.69A8.25 8.25 0 0 1 2.25 10.5Z"
                ...
                <div>
                    <button id="button" type="button" onclick="openAddModal()"  
                        ...
                        <span class="font-semibold text-sm text-white">Add Customer</span>
                    </button>
                </div>
      ...
      ?>
                     ...
                     hover:bg-[#D1BEAB]">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap font-semibold">
                                <?= htmlspecialchars($pelanggan['idPelanggan']) ?>
                            </td>
                            ...
                            <td class="px-4 py-3 whitespace-nowrap">
                                <?= htmlspecialchars($pelanggan['alamatPelanggan']) ?>
                            </td>
                            ...
                            '<?= $pelanggan['kodePos'] ?>'
                                    ...
                                    <button
                                        onclick="openDeleteModal('<?= $pelanggan['idPelanggan'] ?>', '<?= $pelanggan['namaPelanggan'] ?>')"
            ...
            <div id="addModal"
                ...
                <div class="bg-white rounded-lg p-6 w-full max-w-[600px] h-[400px]">
                    <div class="flex justify-between items-center pb-1">
                        <h3 class="text-2xl font-bold mb-4 text-[#16151C]">Add Customer</h3>
                    ...
                    <form action="../../assets/mysql/pemilikUsaha/proses.php" method="POST"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="email" name="emailPelanggan" placeholder="Email" required
                                    class="w-full border rounded-md p-2 focus:ring-2 focus:ring-[#A2845E]">
                            </div>
                        ...
                        <div class="flex justify-end gap-2 mt-2">
                            ...
                            <button type="submit" name="addCustomer"
                                class="flex items-center gap-2 px-4 py-2 bg-[#A2845E] rounded-md hover:bg-[#8C6B42] focus:outline-none transition">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
            ...
            <div id="detailModal"
                ...
                <div class="bg-white rounded-xl p-6 max-w-xl w-full shadow-lg">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-xl font-bold">Customer Detail</h3>
                    ...
                    <div class="flex flex-col md:flex-row gap-4 items-center">
                        <img id="detail-gambar" src="" alt="customer"
                        ...
                        <div class="space-y-2 text-sm md:text-base w-full">
                            ...
                            <div class="flex">
                                <span class="font-semibold w-32">Customer Name</span>
            ...
            <div id="editModal"
                ...
                <div class="bg-white rounded-lg p-6 w-full max-w-md">
                    <h3 class="text-2xl font-bold mb-4 text-[#16151C]">Edit Customer</h3>
                    <form action="../../assets/mysql/pemilikUsaha/proses.php" method="POST"
                        enctype="multipart/form-data">
                        <input type="hidden" name="idPelanggan" id="editId">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-semibold mb-2">Customer Name</label>
                                <input type="text" name="namaPelanggan" id="editNamaPelanggan"
                                    class="w-full border rounded-md p-2 focus:ring-2 focus:ring-[#A2845E]">
                            </div>
                ...
                <div class="bg-white rounded-lg p-6 max-w-md w-full ">
                    ...
                    <div class="flex justify-center gap-2">
                        <form id="deleteForm" action="../../assets/mysql/pemilikUsaha/proses.php" method="POST">
                            <input type="hidden" name="idPelanggan" id="deleteItemId">
                            <div class="mx-auto justify-center flex space-x-2">
                                <button type="button" onclick="closeDeleteModal()"
                                    class="px-4 py-2 border rounded-md hover:bg-gray-100">Cancel</button>
                                <button type="submit" name="deletePelanggan"
...
//show detail
function showDetailModal(pelanggan) {
